...
public class ContactManagerApp {
	...
	public static void main(String[] args) {
		...
		List<Contact> contactNoPhone = filterContacts(contacts, c -> c.getPhone() == null);
		displayContacts(contactNoPhone);

		System.out.println("Contacts no email");
		List<Contact> contactNoEmail = filterContacts(contacts, c -> c.getEmail() == null);
		displayContacts(contactNoEmail);

		System.out.println("Contacts no email nor phone");
		List<Contact> contactNoEmailNoPhone = filterContacts(contacts,
				c -> c.getEmail() == null && c.getPhone() == null);
		displayContacts(contactNoEmailNoPhone);
