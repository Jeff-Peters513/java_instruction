...
public class AdvancedArraysApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("index of 222 =" + idx);
		...
		Product p2 = new Product("andr", "Murach's Android", 55.55);
		Product p3 = new Product("mysql", "Murach's MySQL", 55.55);
		Product p4 = new Product("html", "Murach's HTMl", 55.55);
